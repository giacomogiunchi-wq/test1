...
enum class DefinitionStorageClass { External, EmbeddedVirtual };
...
struct PartDefinition {
  ...
  std::string name;
  DefinitionStorageClass storage{DefinitionStorageClass::External};
...
public:
  ...
  [[nodiscard]] std::vector<std::shared_ptr<const PartDefinition>>
  partDefinitions() const;
  [[nodiscard]] std::vector<std::shared_ptr<const AssemblyDefinition>>
  assemblyDefinitions() const;
  [[nodiscard]] std::vector<std::shared_ptr<const PartRevision>>
  partRevisions() const;
  [[nodiscard]] std::vector<std::shared_ptr<const AssemblyRevision>>
  assemblyRevisions() const;
...
public:
  ...
  [[nodiscard]] std::vector<AssemblyOccurrence> occurrences() const;
